...
def gradAscent(dataMatIn, classLabels):
    ...
    alpha = 0.001
    maxCycles = 500
    weights = ones((n,1))  #w1, w2, w3
    for k in range(maxCycles):
        #dataMatrix*weights
        #100*3 X 3*1 = 100*1, 输入为z值向量
...
def plotBestFit(weights):
    dataArr, labelArr = load_data_set()
...
#labelArr_200 = []
#for i in range(1000):
#    dataArr_200.extend(dataArr)
#    labelArr_200.extend(labelArr)

#weights = stocGradAscent0(dataArr, labelArr)
#weights = stocGradAscent0(dataArr_200, labelArr_200)
#weights = weights.getA() #z转换为数组
